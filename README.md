...
4. Time how long the fast-forwarded chapter lasts when it fails on the first input, add like a second for safety, and edit `settings.yaml` accordingly (and any other changes there if need be)
